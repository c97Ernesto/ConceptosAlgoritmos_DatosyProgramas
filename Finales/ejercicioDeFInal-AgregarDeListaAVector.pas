...
implementar un módulo que reciba la lista y el vector, y agregue al vector 
los elementos que cumplan la condición que sean divisibles por 3. El módulo
debe retornar el vector modificado.
